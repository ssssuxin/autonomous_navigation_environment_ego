...
namespace ego_planner
{
  ...
  private:
    ...
    Eigen::Vector3d last_goal_wp_fromcallback;
    Eigen::Vector3d odom_pos_com_with_last_goal;
    int fail_times_count=0;
    ...
    rclcpp::Subscription<geometry_msgs::msg::PointStamped>::SharedPtr waypoint_sub_point_;
    ...
    rclcpp::Publisher<geometry_msgs::msg::PointStamped>::SharedPtr way_point_showed;
    ...
    void waypointCallback_point(const geometry_msgs::msg::PointStamped::SharedPtr msg);
