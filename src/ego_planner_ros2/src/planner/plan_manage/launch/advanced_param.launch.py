...
def generate_launch_description():
    ...
    ego_planner_node = Node(
        ...
        # 重映射 position_cmd 话题
            ...
            ('grid_map/cloud_lidar', LaunchConfiguration('grid_map/cloud_lidar')),
        ...
        parameters=[
            # local_planner_para_dir,#9
                    ...
                    {'grid_map/local_update_range_x': LaunchConfiguration('local_update_range_x_y_')},
                    {'grid_map/local_update_range_y': LaunchConfiguration('local_update_range_x_y_')},
                    {'grid_map/local_update_range_z': LaunchConfiguration('local_update_range_z_')},
                    {'grid_map/obstacles_inflation': 0.009},
                    # {'grid_map/obstacles_inflation': 0.02},
                    ...
                    {'grid_map/virtual_ceil_height': 25.0},             #限制竖直方向高度
                    {'grid_map/visualization_truncate_height': 25.0},   #限制竖直方向高度
                    ...
                    # {'optimization/lambda_smooth': 4.0},
                    {'optimization/lambda_smooth': 4.0},
